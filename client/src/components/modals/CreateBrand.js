    ...
    >
      ...
      >
        <div className="flex justify-between items-center">
          <div className="m-[15px] font-semibold text-[24px]">Добавить бренд</div>
          <button
        ...
        <div className='flex justify-end'>
          <button onClick={() =>setActive(false)} className='m-[10px] p-[15px] border rounded-md border-red-500 hover:bg-red-100 text-red-500'>Закрыть</button>
          <button onClick={() => addType()} className='m-[10px] p-[15px] ml-2 border rounded-md border-teal-600 hover:bg-teal-100 text-teal-600'>Добавить</button>
        </div>
      </div>
    </div>
  )
